          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 16 * fem, 1 * fem),
                width: 566 * fem,
                height: 140 * fem,
                child: Stack(
                  children: [
              ...
              Container(
                ...
                child: Text(
                  '(+49)1631662xxx | 10422001@student.vgu.edu.vn | dominik.ocsofszki@smail.inf.h-brs.de',
                  textAlign: TextAlign.center,
                  style: MyFont(
                    'Inter',
                    fontSize: 10 * ffem,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(
                          16 * fem, 15 * fem, 22 * fem, 34.13 * fem),
                      width: 286 * fem,
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                          text:
                                              'Further education - CNC specialist (IHK) advanced level B + C\n',
                                        ),
                                        TextSpan(
                                          text: '2013\n',
                                          style: MyFont(
                                        ...
                                        TextSpan(
                                          text:
                                              'Apprenticeship - Technical draftsman (mechanical and plant technology)\n',
                                        ),
                                        TextSpan(
                                          text: '2010-2014\n',
                                          style: MyFont(
